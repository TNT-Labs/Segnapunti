...
REM Usa React Native 0.76.5 per compatibilità con package.json (supporta JDK 21)
call npx react-native@0.76.5 init SegnapuntiTemp --skip-install
...
if %errorlevel% neq 0 (
    ...
    echo    npx react-native@0.76.5 init TempProject
    echo.
