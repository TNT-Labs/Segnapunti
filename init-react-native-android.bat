...
REM Usa React Native 0.73.2 per compatibilità con package.json
call npx react-native@0.73.2 init SegnapuntiTemp --skip-install
...
if %errorlevel% neq 0 (
    ...
    echo    npx react-native@0.73.2 init TempProject
    echo.
